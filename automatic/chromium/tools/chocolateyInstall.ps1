...
$version = '147.0.7703.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1589430/mini_installer.exe'
  checksum      = 'DFF0E17254AEBFB5E4F7DAA913E3BEAB50938B438EF8D57C8D65EB478E793866'
  checksumType  = 'sha256'
