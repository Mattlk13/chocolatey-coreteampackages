...
$version = '147.0.7704.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1590022/mini_installer.exe'
  checksum      = '298B3336DFB3CDD2350A28FF854EF555DC0B2B88DEEAAC13BFC6B08ECCDB166A'
  checksumType  = 'sha256'
