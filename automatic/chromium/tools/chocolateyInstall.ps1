...
$version = '147.0.7714.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1592237/mini_installer.exe'
  checksum      = 'F7992848AC5A13C7D90E5CFEF726A52CE0A8BCC26F984A6B638D6AE077D3D291'
  checksumType  = 'sha256'
