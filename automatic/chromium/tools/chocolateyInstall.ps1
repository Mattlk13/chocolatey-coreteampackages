...
$version = '147.0.7702.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1589230/mini_installer.exe'
  checksum      = '3AFF4ECB019B8907BC00BA80165428B69F869D73AD4A90FB23C653EDD35E869F'
  checksumType  = 'sha256'
