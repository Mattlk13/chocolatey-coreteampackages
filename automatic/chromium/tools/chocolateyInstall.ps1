...
$version = '147.0.7707.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1591047/mini_installer.exe'
  checksum      = 'DD5BD46714589C0EBBB91EA99E9ECC869EC133F8B05F70A7C7915A4F74E59979'
  checksumType  = 'sha256'
