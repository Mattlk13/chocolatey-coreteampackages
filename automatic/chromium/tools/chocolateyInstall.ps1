...
$version = '150.0.7828.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1625183/mini_installer.exe'
  checksum      = '83E1E4536B432B359861C2A644290B94D47E9A07C6F8D07F4B99CB50C30FABF3'
  checksumType  = 'sha256'
