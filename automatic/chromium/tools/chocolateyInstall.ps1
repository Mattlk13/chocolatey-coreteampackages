...
$version = '147.0.7713.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1592161/mini_installer.exe'
  checksum      = 'CFDB78A6FAF8882276CB9712D6883DA8A86F9E242AC0B6D95A5C528D6B6BE997'
  checksumType  = 'sha256'
