...
$version = '150.0.7830.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1626214/mini_installer.exe'
  checksum      = '61719A28B9BD0C1828425F8D992A07BA44EFD32BC1A98D5AE93DE874DCECD1F6'
  checksumType  = 'sha256'
