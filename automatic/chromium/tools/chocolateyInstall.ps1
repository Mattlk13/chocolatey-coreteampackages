...
$version = '147.0.7709.0-snapshots'
$hive = "hkcu"
...
$packageArgs = @{
  ...
  url           = 'https://storage.googleapis.com/chromium-browser-snapshots/Win/1591567/mini_installer.exe'
  checksum      = '01EDA276DD9C4EEA2635C9F3CAA7B7CCAA887F12EFAF83BEA47E92C40F8A7C48'
  checksumType  = 'sha256'
