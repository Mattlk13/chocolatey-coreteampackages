...
$filesInfo = @{
  filets32  = "$toolsPath\php-8.5.6-Win32-vs17-x86.zip"
  filets64  = "$toolsPath\php-8.5.6-Win32-vs17-x64.zip"
  filents32 = "$toolsPath\php-8.5.6-nts-Win32-vs17-x86.zip"
  filents64 = "$toolsPath\php-8.5.6-nts-Win32-vs17-x64.zip"
}
