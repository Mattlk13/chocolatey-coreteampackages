...
$packageArgs = @{
    PackageName    = 'sqlite'
    FileFullPath   = "$toolsDir\sqlite-dll-win-x86-3530100.zip"
    FileFullPath64 = "$toolsDir\sqlite-dll-win-x64-3530100.zip"
...
if (!$pp.NoTools) {
    ...
    $packageArgs.FileFullPath64 = "$toolsDir\sqlite-tools-win-x64-3530100.zip"
    Get-ChocolateyUnzip @packageArgs
}
